                            ...
                            <div className="card-bg-discord box-shadow-bg border-rounded-19 padding-discord-step lg:ml-[2.6rem]">
                                <div className="text-center">
                                    ...
                                    <button onClick={() => {
                                        ...
                                        className={`${discordConnected && 'disable'} button primary discord-btn border-rounded-8 w-full pt-0.5`}>
...

                                    {
                                        ...
                                        <button onClick={() => {
                                            ...
                                            className={`button primary discord-btn border-rounded-8 w-full pt-0.5 mt-3`}>
                                            OPEN DISCORD
                                        </button>
                                    }
                                </div>
