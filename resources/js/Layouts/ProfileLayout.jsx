                ...
                <div>
                    {currentPage !== 'progress' && <div className="   overflow-x-auto block mt-1 ">
                        <div className="containerMedium flex align-items-center justify-center gap-x-2 px-3 ">
                            ...
                            {auth?.user && <Link href={route('profile.payment')} className="w-full">
                        ...
                        <div className="containerMedium mx-auto relative">
                            ...
                            <div className="   w-full flex gap-x-2  px-4 md:px-3">
                                {route().current('profile.security') &&
                                    <button onClick={(e) => { handleLogout(e) }} className="notification-btn flex justify-center gap-x-1.5 text-size  items-center px-[9px] fw-bold bg-[#7E0606] text-[#fff] w-full border-rounded-8 h-[48px] pt-[2px] ">
                                        LOGOUT
                                ...
                                <a onClick={() => { setOpenMobileMenu(false) }}
                                    className="w-full" href="https://capitalclub1498.zendesk.com/hc/en-us" target="_blank">  <button className="notification-btn flex justify-center gap-x-1.5 text-[10px]  items-center px-[9px] fw-bold bg-[#1c1c1e] text-[#fff] w-full border-rounded-8 h-[48px] pt-[1px]">
