...
const ErrorLayout = ({ children, refresh = '', goHome = '', goSupport = '' }) => {
    ...
    return (
        ...
        <div onContextMenu={handleContextMenu} data-aos="fade-in" data-aos-delay="100" data-aos-easing="ease" data-aos-duration="300" className="  pt-[4rem] md:pt-[6.4rem] h-[100vh]  ">
                <div className="text-center flex justify-center">
                    <div>
                        <Link href={route('welcome')}>   <img className="h-7 object-cover" src={logo} alt="" /> </Link>
                    </div>
                </div>
